...
<p align="center"><b>
 ...
 <a href="#---to-do-list-project-------">README em Português 🇧🇷</a>
  </b>
</p>
<h1 align="center">
  📝 To Do List Project
...
<table>
    <tr>
      <td><br>
        <p align="left">
     Nesse projeto podemos colocar em prática o DOM, Modelo de Objeto de Documento, onde podemos manipular HTML, CSS através do JavaScript. Criando seletores e eventos. A proposta era criarmos uma lista de tarefas, uma To Do List. Aonde pudéssemos adicionar itens à lista, remover e editar os itens e ainda salvar a lista no localStorage. Divertido né? </p>
      </td>
    </tr>
    <tr>
      <td><br>
...
Layout
 ...
 <tr><td> 
     WEBSITE
 </td><td><img src="./to-do-list.gif" /></td></tr>
 <tr><td> 
 MOBILE
 </td></tr> 
    </table>
